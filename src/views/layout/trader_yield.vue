    ...
    .trader-yield
        .filter-list 累计收益
            .label(
                ...
                :class="{checked:filterCheckId == index}") {{i.value}}
            .veLine 
                .title 策略收益
        ...
        return{
            ...
            chartData: {
                ...
                rows: [
                    ...
                    { '策略收益': '2020-10-02','收益': '100'},
                    { '策略收益': '2020-10-03','收益': '80'},
                    { '策略收益': '2020-10-04','收益': '70'},
                    { '策略收益': '2020-10-05','收益': '60'},
                    { '策略收益': '2020-10-06','收益': '40'},
                    { '策略收益': '2020-10-07','收益': '400'},
                ]
            },
            veLine: {
                colors: ["#1138FF", "#EEE"],
