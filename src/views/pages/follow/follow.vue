        ...
        data() {
            return {
                ...
                quantList:[
                    {
                        ...
                        chartData: {
                            ...
                            rows: [
                                ...
                                { 策略收益: "2020-10-04", 收益: "24", 中证500: "4.99" },
                                { 策略收益: "2020-10-05", 收益: "22", 中证500: "10" },
                                { 策略收益: "2020-10-06", 收益: "35", 中证500: "4.99" },
                                { 策略收益: "2020-10-07", 收益: "34", 中证500: "4.99" },
                            ],
                        },
                    },{
                        name:'金融老人',
                        ...
                        chartData: {
                            columns: ["策略收益", "收益", "中证500"],
                            rows: [
                                { 策略收益: "2020-10-01", 收益: "14.37", 中证500: "4.99" },
                        ...
                        chartData: {
                            ...
                            rows: [
                                ...
                                { 策略收益: "2020-10-02", 收益: "35.86", 中证500: "4.99" },
                        ...
                        chartData: {
                            columns: ["策略收益", "收益", "中证500"],
                            rows: [
                                { 策略收益: "2020-10-01", 收益: "14", 中证500: "4.99" },
                                { 策略收益: "2020-10-02", 收益: "24.86", 中证500: "4.99" },
                                { 策略收益: "2020-10-03", 收益: "24", 中证500: "4.99" },
                                { 策略收益: "2020-10-04", 收益: "25", 中证500: "4.99" },
                                { 策略收益: "2020-10-05", 收益: "12", 中证500: "10" },
                                { 策略收益: "2020-10-06", 收益: "27", 中证500: "4.99" },
                                { 策略收益: "2020-10-07", 收益: "35", 中证500: "4.99" },
                            ],
                        },
                    }
                ],
                chartData: {
                    ...
                    { 策略收益: "2020-10-02", 收益: "11.86", 中证500: "4.99" },
                    { 策略收益: "2020-10-03", 收益: "13", 中证500: "4.99" },
                    { 策略收益: "2020-10-04", 收益: "17", 中证500: "4.99" },
                    { 策略收益: "2020-10-05", 收益: "16", 中证500: "10" },
                    { 策略收益: "2020-10-06", 收益: "24", 中证500: "4.99" },
                    { 策略收益: "2020-10-07", 收益: "28", 中证500: "4.99" },
                    ],
                },
            }
        },
