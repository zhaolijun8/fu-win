            ...
            .fund-moduler
                .fund-moduler-desc
                    .fund-moduler-desc-top
                        .fund-moduler-desc-name 智汇一号基金介绍
                            span 智汇一号私募基金是一只货币基金产品，成立于2017年03月08日
                ...
                .trader-policy
                    ...
                    .trader-policy-r
                        ...
                        traderYield(:chart-data="chartData")
        ...
        data() {
            return {
                ...
                chartData: {
                    ...
                    { 策略收益: "2020-10-02", 收益: "13.86", 基准收益: "4.99" },
                    { 策略收益: "2020-10-03", 收益: "18", 基准收益: "4.99" },
                    { 策略收益: "2020-10-04", 收益: "17", 基准收益: "4.99" },
                    { 策略收益: "2020-10-05", 收益: "23", 基准收益: "10" },
                    { 策略收益: "2020-10-06", 收益: "45", 基准收益: "4.99" },
                    { 策略收益: "2020-10-07", 收益: "40", 基准收益: "4.99" },
                    ],
                },
            }
        },
